...
export default function InstructionsModal({ isOpen, onClose }: InstructionsModalProps) {
  ...
  const fields = [
    ...
    },
    {
      id: 'objective',
      label: 'Objetivo',
      placeholder: 'Ex: Auxiliar os usuários a...',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    {
      id: 'flow',
      label: 'Fluxo da conversa',
      placeholder: 'Ex: 1. Usuário faz uma pergunta...',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      id: 'restrictions',
      label: 'Restrições',
      placeholder: 'Ex: Não fornecer informações fora do contexto...',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    },
    {
      ...
      placeholder: 'Ex: Outras instruções importantes...',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
